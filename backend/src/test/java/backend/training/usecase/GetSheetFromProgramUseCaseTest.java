...
class GetSheetFromProgramUseCaseTest {
    ...
    @InjectMocks
    private GetSheetFromProgramUseCase useCase;

    @Test
    void executeShouldReturnMappedSheetsWhenProgramExists() {
        ...
        when(sheetQueryPort.findByProgramId(7L)).thenReturn(List.of(sheet));
