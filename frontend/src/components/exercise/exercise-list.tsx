    ...
    return (
        <div className="flex flex-col gap-6">
            <PageHeader
                icon={Dumbbell}
                title="Exercícios"
                subtitle={`${filtered.length} exercício(s) encontrado(s)`}
                action={{ label: "Novo exercício", href: "/exercises/new/edit", icon: Plus }}
            />
                                ...
                                filtered.map((exercise) => {
                                    ...
                                    return (
                                        <TableRow key={exercise.id}>
                                            ...
                                            <TableCell>
                                                <StatusBadge active={exercise.active} />
                                            </TableCell>
                                            <TableCell className="text-right">
                                                <Button asChild variant="outline" size="sm">
                                                    <Link href={`/exercises/${exercise.id}/edit`}>Ver detalhes</Link>
                                                </Button>
                                            </TableCell>
                                        </TableRow>
                                    )
